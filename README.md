...
## Info about 20357
   ...
   We then have our teamcode seperated into RR and Toros. Toros is anycode made or modified by the team while RR is any RoadRunner related OP mode, this would also apply to any other repo we get some sort of code whether OP mode or a utility so other programs could work.
   
   RR is quite easy to understand with the more important stuff being in tuning but to know more look at https://rr.brott.dev/docs/meepmeep/
   
   Toros is then seperated into Drive, Autonomous, and Util. Util being any extra opmodes we use for other reason like testing a servo. Drive is any program used to drive the robot around.
