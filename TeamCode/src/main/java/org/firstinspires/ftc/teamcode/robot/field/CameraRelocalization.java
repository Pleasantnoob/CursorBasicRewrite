package org.firstinspires.ftc.teamcode.robot.field;
...
public class CameraRelocalization {
    ...
    /**
     * Blue goal tag field position (FTC inches, center origin). Must match game manual / AprilTag database.
     * Axes: +X right from Red wall, +Y toward Blue alliance. See docs/FIELD_COORDINATES.md.
     */
    ...
    public static Pose2d robotPoseFromTag(AprilTagDetection d, double tagFieldXInches, double tagFieldYInches, double robotHeadingRad) {
        ...
        // --- 3. Rotate to FTC field frame. Heading 0 = +X, CCW positive. Forward = (cos(h), sin(h)), right = (-sin(h), cos(h)). ---
