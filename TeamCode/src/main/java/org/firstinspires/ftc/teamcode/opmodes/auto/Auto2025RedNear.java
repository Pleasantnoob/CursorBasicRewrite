...
public class Auto2025RedNear extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.drive.setPose(new Pose2d(
                RobotState.redStartX,
                RobotState.redStartY,
                Math.toRadians(RobotState.redStartHeadingDeg)
        ));
        ...
        telemetry.addData(">", "Red Near");
        telemetry.update();
        waitForStart();
        if (!opModeIsActive()) return;

        double r90 = Math.toRadians(90), r125 = Math.toRadians(125), r110 = Math.toRadians(110), r128 = Math.toRadians(128);
        Pose2d p0 = robot.state.getPose();
        Pose2d p1 = new Pose2d(-12, 12, r90);
        Pose2d p2 = new Pose2d(-12, 28, r90);
        Pose2d p3 = new Pose2d(-12, 53, r90);
        Pose2d p4 = new Pose2d(-12, 13, r90);
        Pose2d p5 = new Pose2d(12, 28, r90);
        Pose2d p6 = new Pose2d(12, 53, r90);
        Pose2d p7 = new Pose2d(-13, 12, r90);
        Pose2d p8 = new Pose2d(12, 59, r125);
        Pose2d p9 = new Pose2d(-13, 12, r110);
