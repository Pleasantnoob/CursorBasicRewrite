 ...
 *
 * Field bounds and zones in official FTC center frame (±72 in). See docs/FIELD_COORDINATES.md.
 * Close zone: audience-side triangle at X = −72. Far zone: rear triangle at X ≈ +72.
 */
@Config
