 ...
 * Projectile model: launch at height H, flat ground; constants match FlywheelSubsystem feedforward.
 */
public final class ShotPhysics {
    private static final double G = 9.81;
    /** Launch height above target plane (m). Must match flywheel feedforward model. */
